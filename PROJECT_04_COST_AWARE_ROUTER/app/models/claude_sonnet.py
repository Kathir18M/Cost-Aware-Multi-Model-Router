"""Legacy sonnet wrapper mapped to the Mistral provider."""
...
class ClaudeSonnet(MistralModel):
	"""Compatibility wrapper that keeps the old logical name while using Mistral."""
	...
	def __init__(
		...
		*,
		...
		self.model = (settings.sonnet_model if settings and settings.sonnet_model else settings.mistral_model if settings else "mistral-small-latest")
